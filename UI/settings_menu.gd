...
@onready var music_slider = $Panel/MarginContainer/VBoxContainer/GridContainer/MusicSlider
@onready var sfx_slider = $Panel/MarginContainer/VBoxContainer/GridContainer/SFXSlider
